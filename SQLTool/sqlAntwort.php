...
<!--this is the answer which will we printed out on the "ausgabebereich" id="fehlerausgabe" and id="ausgabebereich". for desktop -->
      ...
      <td>
				...
				<?php error_reporting(2);  ?>
					...
					<!--*** Ergebnis anzeigen/ show results ---------------------------------------------------------------------------------->
					 <p> SQL-String: <u><?php echo $db_sql ?> </u></p>
					...
					<table border="1" bordercolor="#aeaeae" style="background-color:#aeaeae;" cellspacing="0" cellpadding="2">
					 ...
					 <div id='fehlerausgabe'><?php 
						if(true ==  $query->execute()){
							echo "<div class='text-center col-sm-12' style='text-align:center;font-weight:normal;'>Gefundene Datens&auml;tze: ";
